...
def main() -> None:
    ...
    packs = []
    gold_costs = [500, 1200, 2500, 0, 0, 0]
    gem_costs = [0, 0, 75, 150, 350, 750]
    for tier, gold, gems in zip(PACK_TIERS, gold_costs, gem_costs):
        packs.append(
            {
                ...
                "currency": "gems" if gold == 0 else "gold",
                "cost": gems if gold == 0 else gold,
            }
        )
