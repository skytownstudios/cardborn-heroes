...
const HERO_BASE = [
  { suffix: "knight", name: "Knight", role: "tank", stats: { hp: 1200, atk: 85, def: 60 }, description: "Frontline shield bearer." },
  { suffix: "archer", name: "Archer", role: "ranger", stats: { hp: 750, atk: 110, def: 35 }, description: "Ranged striker." },
  { suffix: "mage", name: "Mage", role: "caster", stats: { hp: 680, atk: 130, def: 25 }, description: "Arcane damage dealer." },
];
const GEAR_BASE = [
  { suffix: "sword", name: "Sword", slot: "weapon", bonus: { atk: 25, def: 10, hp: 0 }, compatibleRoles: ["tank", "ranger"], description: "A sturdy blade." },
  { suffix: "bow", name: "Bow", slot: "weapon", bonus: { atk: 35, def: 0, hp: 50 }, compatibleRoles: ["ranger"], description: "Standard ranged weapon." },
  { suffix: "staff", name: "Staff", slot: "weapon", bonus: { atk: 40, def: 0, hp: 30 }, compatibleRoles: ["caster"], description: "Focuses arcane power." },
];
...
for (const tier of DROP_TIERS) {
  ...
  for (const base of HERO_BASE) {
    heroes.push({
      ...
      tier,
      rarity: tier,
      art: `heroes/${base.suffix}/portrait.png`,
      battleRig: base.suffix,
...
console.log(`Wrote ${heroes.length} heroes, ${len(gear)} gear, ${packs.length} packs`);
